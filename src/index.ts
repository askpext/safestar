...
function printReport(report: any) {
    ...
    if (report.status === 'FAIL') console.log(`Status: ${chalk.red.bold('FAIL')}`);
    else if (report.status === 'WARN') console.log(`Status: ${chalk.yellow.bold('WARN')}`);
    else console.log(`Status: ${chalk.green.bold('PASS')}`);
